...
router.put('/:id', auth, roles('admin', 'empleado'), validate(actualizarReservaSchema), controller.actualizar);
router.patch('/:id/cancelar', auth, roles('admin', 'empleado'), controller.cancelar);
